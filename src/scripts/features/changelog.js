...
var changelogData=[
  {id:'24',date:'2026-09-21',iconBg:'#e6f7f0',iconColor:'#0d9d6c',team:'协作开发与专家知识优化',body:'协作人员管理重构为团队模型（团队列表+详情两层，支持新建、归档、设队长），任务管理改为统计卡+下拉筛选布局，全局「小队」更名「团队」、「扭转」更名「流转」；专家详情知识页签改为左树右表独立滚动布局。'},
  {id:'23',date:'2026-09-20',iconBg:'#eef3ff',iconColor:'#3d63dd',team:'专家知识体系重构',body:'专家新增独立知识页签（左目录右文档，与能力项挂钩，支持文档预览）；专家知识界面统一为目录模型，分预置与自己上传两层；专家团配置弹窗改为单页，去掉固定运行流程改为动态组队；全局「召唤」相关文案改为「对话」。'},
