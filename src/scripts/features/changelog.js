...
/* ---------- Changelog / 更新日志 ---------- */
var changelogData=[
  {id:'41',date:'2026-09-24',iconBg:'var(--brand-fill)',iconColor:'var(--brand)',type:'优化',module:'任务',author:'吴晓锋',team:'任务列表与详情交互优化',body:'任务列表新增可排序的模块列和工具栏新建入口，子任务展开支持动效和折叠记忆；列表与详情的处理人选择支持搜索，详情展示模块与分钟级时间；更多菜单支持复制和删除，流转与评论写入动态记录；产物移入详情正文并以附件样式展示；新版任务页嵌入协作开发任务管理页签，保留工作区与页签栏，旧版页面保留供查阅；全局 ESC 键关闭所有表单弹窗。'},
