...
/* ---------- Changelog / 更新日志 ---------- */
var changelogData=[
  {id:'42',date:'2026-09-25',iconBg:'var(--brand-fill)',iconColor:'var(--brand)',type:'功能',module:'协作开发',author:'吴宏超',team:'项目与设置体验优化',body:'项目新增只读编码和六色文件夹图标，卡片按状态分组；设置新增配置审计日志，记录人员、系统集成与项目配置变更，支持筛选和导出；人员角色收敛为成员和管理员；新增工作区创建、自动切换和名称、描述维护，工作区平级且协作数据隔离；无工作区时引导创建，创建后引导建立项目；预置工作区补充项目与任务样例，新建工作区保持空白。'},
  {id:'41',date:'2026-09-24',iconBg:'var(--brand-fill)',iconColor:'var(--brand)',type:'优化',module:'任务管理',author:'吴晓锋',team:'任务列表与详情交互优化',body:'任务列表新增可排序的模块列和工具栏新建入口，子任务展开支持动效和折叠记忆；列表与详情的处理人选择支持搜索，详情展示模块与分钟级时间；更多菜单支持复制和删除，流转与评论写入动态记录；产物移入详情正文并以附件样式展示；任务列表抽为通用模板，项目详情复用同一列表布局、模拟数据和交互并隐藏任务管理标题；旧版页面保留供查阅；详情标签支持搜索、多选、创建与管理；显示设置新增可搜索、显隐与拖拽排序的列表字段设置；开始任务改用播放图标，右键可切换回发起会话；全局 ESC 键关闭所有表单弹窗；任务列表与项目列表的视觉外壳统一为共享 CSS 变量。'},
  ...
  {id:'38',date:'2026-09-23 21:15',iconBg:'var(--brand-fill)',iconColor:'var(--brand)',type:'功能',module:'任务管理',author:'吴晓锋',team:'子任务创建与父子嵌套展示',body:'任务支持创建子任务并自动继承父任务信息；看板和列表按父子关系分组展示，可折叠展开；任务详情可查看子任务完成进度。'},
  {id:'37',date:'2026-09-23 20:30',iconBg:'var(--brand-fill)',iconColor:'var(--brand)',type:'功能',module:'任务管理',author:'吴晓锋',team:'任务管理页面全新重构',body:'任务管理页面全新重构，看板和列表按项目-模块-任务的父子关系分组展示，支持筛选排序与拖拽流转；任务详情可添加子任务，列表可拖拽列宽和排序；项目可直接维护成员并查看任务进度。'},
...
var changelogIcons={
  '42':'<svg class="ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round" style="width:18px;height:18px"><path d="M3 6.5A2.5 2.5 0 0 1 5.5 4h4l2 2H18.5A2.5 2.5 0 0 1 21 8.5v9A2.5 2.5 0 0 1 18.5 20h-13A2.5 2.5 0 0 1 3 17.5z"/></svg>',
