...
var changelogData=[
  {id:'29',date:'2026-09-22',iconBg:'var(--brand-fill)',iconColor:'var(--brand)',team:'项目管理交互优化',body:'项目列表卡片直接内嵌模块列表与协作人员，无需展开详情即可查看和操作模块；模块标签页提升至第一位；协作人员区域可点击跳转到人员与权限页签。'},
  ...
  {id:'27',date:'2026-09-22',iconBg:'var(--brand-fill)',iconColor:'var(--brand)',team:'任务详情、评审与运行期协作链路优化',body:'任务详情重设计为左侧任务内容、右侧紧凑属性栏，任务按环节推进：本人评审 AI 生成的产物，通过后提交 Git 并流转到下一个环节（最后环节通过即完成）；项目任务规划按特性组织，智能拆解与人工拆解生成特性，特性下推生成任务并挂到对应特性下；任务负责人只能指定人，不能选专家团；专家团和项目成员在新建项目时选择，负责人自动加入成员；项目管理将搜索与新建入口上移，项目详情补充概述，任务规划收敛为右侧「模块」页签；专家团配置合并为基本信息、能力与流程、触发词三个页签；项目卡片与专家/专家团卡片风格统一，任务均明确负责人，卡片支持快速转交，详情按默认折叠的流程节点展示对应产物，交付产物统一汇总并支持预览；工作区设置改为左导航 + 右表单。'},
