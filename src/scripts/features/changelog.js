...
var changelogData=[
  {id:'30',date:'2026-09-23',iconBg:'var(--brand-fill)',iconColor:'var(--brand)',team:'项目成员与任务进度',body:'设置中维护人员资料及 DevOps、禅道任务来源配置，支持录入第三方应用 ID 与密钥，无需选择灵基项目；项目直接维护成员并在详情中提供成员页签，列表用头像和人数概览成员，旧团队成员自动迁入项目；创建时必须选择专家团，列表与卡片支持状态、优先级、负责人快速编辑，起止时间仅在列表编辑，其他信息只读；项目筛选移入工作台工具栏；模块支持展示切换、过滤、搜索、创建，点击名称或任务数量可展开任务列表，任务可直接进入详情，移除模块附件和验收标准。'},
