...
var changelogData=[
  ...
  {id:'40',date:'2026-09-24',iconBg:'var(--brand-fill)',iconColor:'var(--brand)',type:'优化',module:'协作开发',author:'吴宏超',team:'项目任务、详情与成员管理优化',body:'项目定义项统一称为任务，新建时可选上级任务，独立任务也会显示在项目详情；项目详情移除搜索，右侧项目摘要可收起以展开内容区。项目详情左侧嵌入按当前项目筛选的任务管理面板，第一期仅展示可执行任务；右侧仅保留项目属性，成员管理从详情右上角进入独立页面，按邀请、成员、待处理邀请、分享链接分区展示。成员邀请支持手机号或邮箱，默认角色为成员，由管理员在成员列表设置；7天有效分享链接支持更新、复制和撤销；移除前检查未完成任务并二次确认。设置页保留人员和系统集成入口。新建任务支持一句话生成可编辑草稿，并在对话中补充要求后确认创建。 工作区新增系统管理员与项目经理角色；项目由两者创建，项目列表按我负责的和我参与的筛选，项目成员改为从工作区人员中添加。人员支持 CSV 导入预览，金蝶组织/人员系统同步展示待接入状态。项目经理或项目负责人可编辑项目并管理成员，其他人只读；成员添加支持浮层搜索和多选；项目页签及列表字段只读，详情变更负责人需确认；修复切换项目偶发空白，补充负责与参与项目的演示数据。'},
