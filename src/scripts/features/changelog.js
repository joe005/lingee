...
/* ---------- Changelog / 更新日志 ---------- */
var changelogData=[
  {id:'46',date:'2026-09-25',iconBg:'var(--brand-fill)',iconColor:'var(--brand)',type:'功能',module:'协作开发',author:'吴宏超',team:'项目与设置体验优化',body:'项目新增只读编码和六色文件夹图标，卡片按状态分组；设置新增配置审计日志，记录人员、系统集成与项目配置变更，支持筛选和导出；人员角色收敛为成员和管理员；新增平级工作区的创建、自动切换、资料维护和删除确认，并按工作区隔离协作数据；无工作区时引导创建，预置工作区补充项目与任务样例。'},
  {id:'45',date:'2026-09-25',iconBg:'var(--brand-fill)',iconColor:'var(--brand)',type:'优化',module:'任务管理',author:'wuhc2023',team:'内置视图「我创建」改为「进行中」',body:'任务管理内置视图方案「我创建」改为「进行中」，筛选范围从按当前用户创建的任务改为按状态筛选进行中的任务；保存视图弹窗的任务范围选项同步更新。'},
  {id:'44',date:'2026-09-25',iconBg:'var(--brand-fill)',iconColor:'var(--brand)',type:'优化',module:'项目管理',author:'wuhc2023',team:'项目列表 UI 精简优化',body:'项目列表「新建项目」按钮文案简化为「新建」，显示设置图标更换为齿轮以与任务管理保持一致，去除页面标题「项目」右侧的数字计数；项目视图栏新增视图管理图标按钮。'},
  {id:'43',date:'2026-09-25',iconBg:'var(--brand-fill)',iconColor:'var(--brand)',type:'功能',module:'任务管理',author:'wuhc2023',team:'Lingee 原型开发平台演示任务',body:'吴晓峰负责的「Lingee 原型开发平台」20 条模拟任务已接入任务管理列表，支持按项目、处理人和状态查看；任务列表移除模块列及详情属性面板的模块选择器；审核中任务的动态新增按项目专家团分工展示的模拟执行报告与人工审核要点；阻塞与已完成任务的动态分别展示智能体失败或成功运行、执行步骤和对应结果，并支持阻塞任务模拟重试；任务产物随交付阶段动态展示并支持原位预览，执行报告保留已产生的产物汇总；动态标题右侧展示模拟运行阶段和对应处理智能体；旧版任务详情归入头像菜单的废弃页面，新版详情改为独立评论输入框，支持按项目搜索并 @ 人员、智能体和专家团成员；项目内嵌任务列表与任务管理详情按绑定专家团和六个交付阶段展示过程动态，阶段执行专家头像、产物、评论及状态变化合并为按时间排列的动态，并参考 Multica 以专家运行卡片、人员评论卡片和可折叠的紧凑操作记录区分动态；各任务状态补齐运行反馈，显示当前动作、执行耗时及可展开步骤；专家动态将阶段与姓名并排展示，执行完成后按审核流程记录状态变化，操作文案对齐 Multica。'},
  {id:'42',date:'2026-09-25',iconBg:'var(--brand-fill)',iconColor:'var(--brand)',type:'功能',module:'协作开发',author:'吴晓峰',team:'Lingee 原型开发平台演示项目',body:'新增「Lingee 原型开发平台」模拟项目，负责人为吴晓峰，成员包含全部 22 位工作区人员，预置 20 个父任务和 20 条子任务，覆盖需求、Bug、任务、改进四种类型与全状态流转；新建任务弹窗参考 Multica 1:1 复刻为宽幅编辑器风格，手动/智能体双模式切换，智能体模式支持一句话生成草稿、确认创建与继续创建，原有弹窗已备份。'},
  {id:'41',date:'2026-09-24',iconBg:'var(--brand-fill)',iconColor:'var(--brand)',type:'优化',module:'任务管理',author:'吴晓峰',team:'任务列表与详情交互优化',body:'任务列表新增可排序的模块列和工具栏新建入口，子任务展开支持动效和折叠记忆；列表与详情的处理人选择支持搜索，详情展示模块与分钟级时间；更多菜单支持复制和删除，流转与评论写入动态记录；产物移入详情正文并以附件样式展示；任务列表抽为通用模板，项目详情复用同一列表布局、模拟数据和交互并隐藏任务管理标题；旧版页面保留供查阅；详情标签支持搜索、多选、创建与管理；显示设置新增可搜索、显隐与拖拽排序的列表字段设置；开始任务改用播放图标，右键可切换回发起会话；全局 ESC 键关闭所有表单弹窗；任务列表与项目列表的视觉外壳统一为共享 CSS 变量。'},
  {id:'40',date:'2026-09-24',iconBg:'var(--brand-fill)',iconColor:'var(--brand)',type:'优化',module:'协作开发',author:'吴宏超',team:'项目任务、详情与成员管理优化',body:'项目定义项统一称为任务，新建时可选上级任务，独立任务也会显示在项目详情；项目详情移除搜索，右侧项目摘要可收起以展开内容区。项目详情左侧嵌入按当前项目筛选的任务管理面板，第一期仅展示可执行任务；右侧仅保留项目属性，成员管理从详情右上角进入居中弹窗，从工作区人员中搜索、多选添加和移除；移除前检查未完成任务并二次确认。设置页保留人员和系统集成入口。新建任务支持一句话生成可编辑草稿，并在对话中补充要求后确认创建。 工作区新增系统管理员与项目经理角色；项目由两者创建，项目列表按我负责的和我参与的筛选，项目成员改为从工作区人员中添加。人员改为搜索灵基用户并按用户 ID 建立协作关联，展示姓名、手机号、邮箱；接口待接入时使用明确标注的演示数据。项目经理或项目负责人可编辑项目并管理成员，其他人只读；成员添加支持浮层搜索和多选；项目页签及列表字段只读，详情变更负责人需确认；修复切换项目偶发空白，补充负责与参与项目的演示数据。新建项目默认将当前用户加入成员，详情从工作区人员中搜索并批量添加，成员弹窗提供添加和移除按钮。新建项目负责人初始留空，可搜索选择工作区所有可用人员；创建者与负责人自动加入项目成员。专家创建与编辑移除职称字段，新增技能页签，支持搜索并多选关联技能，详情页改为展示关联技能。项目成员管理从覆盖式页面改为居中弹窗，成员列表展示手机号和邮箱，并保留搜索添加、移除确认与未完成任务校验。专家团配置移除能力覆盖展示，交付阶段改为紧凑的横向流程图。第一期关闭专家和专家团创建入口，保留已有内容的查看、对话与关联。项目列表增加任务管理式快速过滤、按项目字段的两级筛选与视图切换，详情中开放任务看板与列表视图切换；项目与任务列表的标题、页签共用组件和样式；任务演示人员统一从项目成员获取，按当前登录用户筛选我负责与我创建；任务管理仅显示已加入项目的任务，演示项目补齐吴宏超的成员身份并保留负责与参与的区分。'},
  {id:'39',date:'2026-09-23',iconBg:'var(--brand-fill)',iconColor:'var(--brand)',type:'优化',module:'项目管理',author:'吴宏超',team:'新建任务体验优化',body:'新建任务采用宽幅写作区，单人执行与多人协作分别配置负责人和执行阶段。'},
  {id:'38',date:'2026-09-23 21:15',iconBg:'var(--brand-fill)',iconColor:'var(--brand)',type:'功能',module:'任务管理',author:'吴晓峰',team:'子任务创建与父子嵌套展示',body:'任务支持创建子任务并自动继承父任务信息；看板和列表按父子关系分组展示，可折叠展开；任务详情可查看子任务完成进度。'},
  {id:'37',date:'2026-09-23 20:30',iconBg:'var(--brand-fill)',iconColor:'var(--brand)',type:'功能',module:'任务管理',author:'吴晓峰',team:'任务管理页面全新重构',body:'任务管理页面全新重构，看板和列表按项目-模块-任务的父子关系分组展示，支持筛选排序与拖拽流转；任务详情可添加子任务，列表可拖拽列宽和排序；项目可直接维护成员并查看任务进度。'},
  {id:'36',date:'2026-09-23 20:00',iconBg:'var(--brand-fill)',iconColor:'var(--brand)',type:'功能',module:'更新日志',author:'吴晓峰',team:'更新日志改为独立页面',body:'更新日志从顶部铃铛改为用户菜单中的独立页面，用表格展示并支持按类型、模块和更新人筛选；顶部铃铛保留改为系统通知入口。'},
  {id:'29',date:'2026-09-22 16:45',iconBg:'var(--brand-fill)',iconColor:'var(--brand)',type:'功能',module:'项目管理',author:'吴宏超',team:'项目管理重构',body:'项目详情改为左侧标签页+右侧属性栏布局，属性栏参考 multica 采用可折叠分区与 PropRow 行布局；新增概览页签展示项目背景，任务规划改名为模块；项目新增状态标识（planned/in_progress/paused/completed/cancelled）；新建项目弹窗重构为上下布局，成员选择改为独立弹出层支持搜索多选；右侧属性栏支持内联编辑。'},
  {id:'27',date:'2026-09-22 16:45',iconBg:'var(--brand-fill)',iconColor:'var(--brand)',type:'优化',module:'项目管理',author:'吴宏超',team:'任务详情、评审与运行期协作链路优化',body:'任务详情重设计为左侧任务内容、右侧紧凑属性栏，任务按环节推进：本人评审 AI 生成的产物，通过后提交 Git 并流转到下一个环节（最后环节通过即完成）；项目任务规划按特性组织，智能拆解与人工拆解生成特性，特性下推生成任务并挂到对应特性下；任务负责人只能指定人，不能选专家团；专家团在新建项目时选择，绑定结果自动继承到任务；专家团配置合并为基本信息、能力与流程、触发词三个页签；项目卡片与专家/专家团卡片风格统一，任务均明确负责人，卡片支持快速转交，详情按默认折叠的流程节点展示对应产物，交付产物统一汇总并支持预览；工作区设置改为左导航 + 右表单。'},
  {id:'26',date:'2026-09-21 14:20',iconBg:'#eaf1ff',iconColor:'#3d63dd',type:'功能',module:'项目管理',author:'吴宏超',team:'协作开发重构：工作区与项目管理',body:'协作开发重构：工作区固定顶部、项目切换器在任务/项目管理右侧，专家团升为一级页签；项目管理按「项目目标+里程碑→任务拆分→关联任务」三层组织，智能拆解调用智能体在对话框输出、逐项确认后生成；新建任务支持手动/通过智能体两种方式；任务详情复用新会话对话框，任务对话改为会话列表（每行一条会话总结）并可进入会话、支持发起会话与转交任务；人员独立基础资料；产物带后缀名、代码类按目录弹文件列表；新增多角色登录演示。'},
  {id:'25',date:'2026-09-21 14:20',iconBg:'var(--brand-fill)',iconColor:'var(--brand)',type:'优化',module:'项目管理',author:'吴宏超',team:'协作开发体验升级',body:'任务管理升级为状态看板与列表，任务详情采用左侧任务主页、右侧属性栏的页内工作台；专家新增技能页签与技能用途说明，内置专家团聚焦苍穹应用开发、通用应用开发、金蝶 SaaS 实施和金蝶二次开发，同时修复交互弹窗居中规则。'},
  {id:'24',date:'2026-09-21 14:20',iconBg:'#e6f7f0',iconColor:'#0d9d6c',type:'功能',module:'项目管理',author:'吴宏超',team:'协作人员改为团队模型',body:'协作人员管理重构为团队模型：团队列表与详情两层（概况卡＋成员/指引页签），支持新建团队、归档、添加成员、设某成员为队长（一队一队长），去掉智能体概念；任务管理改为统计卡在上、搜索与下拉筛选在下的布局，状态筛选改下拉并与统计卡点选联动；专家详情知识页签左栏分预置/关联企业/上传三组；全局「小队」更名「团队」、「扭转」更名「流转」。'},
  {id:'23',date:'2026-09-21 14:20',iconBg:'#eef3ff',iconColor:'#3d63dd',type:'优化',module:'专家团',author:'吴宏超',team:'专家知识左树右表布局',body:'专家详情弹窗知识页签改为左树右表独立容器+独立滚动条，补全 .x-detail-pane 断裂的 flex 链条；去掉文档卡片复选框和目录点击筛选；预置知识支持子级目录展示；添加企业知识弹窗右侧不再支持文档级排除，默认全部加进来；去掉知识页签的灰色提示文字。'},
  {id:'22',date:'2026-09-21 14:20',iconBg:'#eef3ff',iconColor:'#3d63dd',type:'修复',module:'专家团',author:'吴宏超',team:'知识搜索修复',body:'修复专家知识搜索框无法输入中文：三处搜索框（添加企业知识弹窗、详情弹窗知识页签、编辑器知识页签）在输入法组合输入时直接重渲染 DOM 打断输入，现按 compositionstart/compositionend 模式跳过组合过程中的重渲染；添加企业知识弹窗点确定时如未勾选任何目录给出提示，避免用户以为按钮没反应。'},
  {id:'21',date:'2026-09-20 10:15',iconBg:'#eaf1ff',iconColor:'#3d63dd',type:'优化',module:'专家团',author:'吴宏超',team:'知识界面统一为目录模型',body:'自己创建的专家点击卡片直接进编辑表单，不再先弹只读详情。知识界面统一为「目录」模型：预置知识、知识扩展（原「自己的知识」）、自己上传的文件都以目录形式摆在左边，点目录筛选右边文档；预置知识支持看到目录名和文件名，但不能查看正文、不能修改；关联的企业知识目录支持对单篇文档单独勾选排除；预置专家的知识改动先落草稿，页脚新增「取消／保存」；「添加企业知识」弹窗定死高度，不再随搜索结果忽大忽小；修复专家卡片鼠标悬停出现的蓝色描边。'},
  {id:'20',date:'2026-09-20 10:15',iconBg:'#e6f7f0',iconColor:'#0d9d6c',type:'功能',module:'专家团',author:'吴宏超',team:'专家知识分预置与自己上传',body:'专家知识分两层：预置知识是 Lingee 内置专家按能力项配置好的，官方维护，不可查看也不可修改，详情弹窗只报一个锁住的篇数；自己的知识谁都能在专家详情里直接上传文件，不用先编辑。自己创建的专家不受影响，仍是关联企业知识 + 上传两块。创建/编辑专家弹窗定死高度，三个页签来回切不再跳动；专家团成员卡片去掉重复的职位行；全局把「召唤」相关文案改成「对话」。'},
  {id:'19',date:'2026-09-20 10:15',iconBg:'#f0e6ff',iconColor:'#7c3aed',type:'优化',module:'专家团',author:'吴宏超',team:'专家团弹窗改成单页',body:'专家团配置弹窗取消页签，团队、成员、能力覆盖、触发词合并到同一屏；查看内置专家团时不再重复摆只读表单——标题已经是名字，正文只留一句话说明，只读提示和「名称」输入框都去掉，自建团的编辑表单不受影响；专家详情弹窗定死高度，「概览／知识」页签切换不再跳动。'},
  {id:'18',date:'2026-09-20 10:15',iconBg:'#fef3ea',iconColor:'#e8792d',type:'优化',module:'专家团',author:'吴宏超',team:'专家团去掉固定运行流程',body:'专家团不再展示写死的「运行流程」和人工确认节点——专家团是动态组队，谁做哪一步由编排在运行时决定，配置弹窗现在只定义团队（名称、成员、能力覆盖）和触发词；专家详情弹窗加宽到跟专家团弹窗一样（720px），「概览／知识」页签切换时高度基本不跳动；「一句话交给 expert-manager」的入口只在第一个页签显示；知识「＋ 添加」改为独立模态框，左边勾选目录、右边看目录内容，确定才生效。'},
  {id:'17',date:'2026-09-20 10:15',iconBg:'#e8f4ff',iconColor:'#1a73e8',type:'功能',module:'专家团',author:'吴宏超',team:'专家新增知识页签',body:'专家新增独立的「知识」页签，形态跟智能体开发的知识页签同构：左边一列关联目录（勾选框+名字+篇数），右边文档卡片，支持添加、上传；知识与能力项挂钩，目录声明服务哪些能力项，专家勾了对应能力项即自动带出目录并标注服务哪项能力，也支持手动追加不对应能力项的目录；文档支持预览；专家详情弹窗顶部新增「概览／知识」页签，概览与知识分开看，不再堆一起越拉越长；专家管理卡片新增「知识」统计。'},
  {id:'16',date:'2026-09-18 11:00',iconBg:'#f0e6ff',iconColor:'#7c3aed',type:'功能',module:'系统通知',author:'吴晓峰',team:'新增用户行为分析页面',body:'新增用户行为分析页面，包含 KPI 指标概览、开发模式分布、增长趋势、功能使用排行、技能调用排名及错误分析六大统计模块。'},
  {id:'15',date:'2026-09-14 09:30',iconBg:'#fff1e8',iconColor:'#ff8d42',type:'优化',module:'应用开发',author:'吴晓峰',team:'应用开发列表 新建体验优化',body:'去除新建应用弹窗，新建应用流程调整为下拉选择应用开发类型，跳转到新会话。'},
  {id:'14',date:'2026-09-14 09:30',iconBg:'#e8faef',iconColor:'#08a040',type:'功能',module:'专家团',author:'吴宏超',team:'专家团支持人工审核确认节点',body:'专家团运行流程可在任意步骤后插入人工审核确认节点，到该节点编排暂停、确认后才继续；专家能力项由机器标识改为中文名加等级展示，专家卡片增加「可承担的工作」，专家团补充领域标签与能力覆盖；专家定义去掉「工作方式」「完成标准」，改为把需要用户提供的内容写进触发词占位符，发送时没填就在会话里追问；专家来源合并为「Lingee 内置」与「我创建的」两档，取消无数据支撑的「金蝶官方」；专家详情收敛为简介、触发词、挂载技能、能力项、可承担的工作五项；修复搜索框被浏览器自动填充账号导致列表被筛空。'},
  {id:'13',date:'2026-09-11 14:00',iconBg:'#fce4ec',iconColor:'#e53935',type:'功能',module:'新会话',author:'吴晓峰',team:'会话加号下拉菜单',body:'会话输入框加号按钮改为下拉菜单，提供添加文件（含本地文件、引用文件夹、知识库）、模式（含 Spec、目标）、连接器（含腾讯云等八项服务）三级菜单结构。'},
  {id:'12',date:'2026-09-09 10:45',iconBg:'#e0f7fa',iconColor:'#00838f',type:'功能',module:'协作开发',author:'吴晓峰',team:'新增协作开发模块',body:'左侧「专家」菜单改为「协作开发」，下设任务管理、待评审、协作人员管理、专家管理、专家团管理与设置六个页签；新增项目维度，任务、评审、协作人员按项目划分，专家与专家团为全局资产、项目内只绑定默认专家团。'},
  {id:'11',date:'2026-09-08 16:20',iconBg:'#eef3ff',iconColor:'#495dff',type:'功能',module:'系统通知',author:'吴晓峰',team:'原型新增登录页',body:'新增登录页，需账号密码登录后才能查看原型。'},
  {id:'10',date:'2026-08-27 09:15',iconBg:'#eef3ff',iconColor:'#495dff',type:'功能',module:'应用开发',author:'吴晓峰',team:'苍穹应用开发 · 预览区新增列表页签',body:'预览面板页签新增「列表」选项，支持列表视图展示。'},
  {id:'9',date:'2026-08-27 09:15',iconBg:'#e8faef',iconColor:'#08a040',type:'功能',module:'应用开发',author:'吴晓峰',team:'苍穹应用开发 · 历史版本',body:'新增历史版本面板，支持查看版本时间线与版本描述，可回退到历史版本。'},
  {id:'8',date:'2026-07-30 13:40',iconBg:'#fff1e8',iconColor:'#ff8d42',type:'功能',module:'系统通知',author:'吴晓峰',team:'新增 Design System 模块',body:'涵盖基础、布局、导航、数据录入、数据展示、反馈 6 大类共 67 个组件，提供组件预览、设计令牌展示、图标库等能力，作为 Lingee 统一的设计规范与组件文档平台。'},
  {id:'7',date:'2026-07-28 10:30',iconBg:'#eef3ff',iconColor:'#495dff',type:'优化',module:'应用开发',author:'吴晓峰',team:'应用开发关联应用交互优化',body:'1、会话框：项目选择与应用选择分开展示\n2、下拉面板去除创建应用流程，调整为关联选择全量应用\n3、苍穹应用：选择关联苍穹应用，发起会话时应用开发列表自动创建展示苍穹应用卡片\n4、通用应用：无需关联应用，自动生成产物应用卡片\n5、未选择开发模式，意图识别苍穹应用开发时，会话过程收集苍穹应用编码\n6、选择应用时，下次新会话按项目记忆用户选项\n\n[视觉稿](https://www.figma.com/design/F8s5P9Y8f1Bq2GkXKCkC7L/%E5%BC%80%E5%8F%91?node-id=0-1&t=DHlFenPtUNP6C7Z5-1)'},
];
