...
var changelogData=[
  {id:'31',date:'2026-09-23',iconBg:'var(--brand-fill)',iconColor:'var(--brand)',team:'新增任务管理 v2 页面',body:'参考 Multica Issues 界面 1:1 复刻任务管理 v2：支持看板/列表双视图、视图标签栏管理（新建/切换/重命名/删除）、多条件筛选（Chip 标签展示）、分组与排序、任务拖拽流转、批量操作、新建/编辑弹窗、任务详情侧滑面板，预置 32 条演示数据。'},
  {id:'30',date:'2026-09-23',iconBg:'var(--brand-fill)',iconColor:'var(--brand)',team:'项目成员与任务进度',body:'设置中维护人员资料及 DevOps、禅道任务来源配置，支持录入第三方应用 ID 与密钥，无需选择灵基项目；项目直接维护成员并在详情中提供成员页签，成员选择支持搜索、批量添加和已选人数，列表用头像和人数概览成员，旧团队成员自动迁入项目；所有选人入口支持搜索，单人单选、多人多选并显示已选人数；新建项目默认由当前账号负责，项目成员和专家团必选；列表与卡片支持状态、优先级、负责人快速编辑，起止时间仅在列表编辑，其他信息只读；项目筛选移入工作台工具栏；模块支持展示切换、过滤、搜索、创建，点击名称或任务数量可展开任务列表，任务可直接进入详情，移除模块附件和验收标准。'},
