...
(function(){
  ...
  var changelogData=[
    {id:'16',date:'2026-09-15',iconBg:'#eef3ff',iconColor:'#495dff',team:'React 化迁移 Phase 0 + Phase 1',body:'接入 React 18 + antd 5 + react-router-dom，应用开发/技能开发/智能体开发三个卡片网格迁移为 React 组件，构建产物改用 @vitejs/plugin-legacy 继续支持 file:// 双击打开。'},
  ...
  var changelogIcons={
    '16':'<svg class="ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px"><path d="M21 12a9 9 0 1 1-2.64-6.36"/><path d="M21 3v6h-6"/></svg>',
